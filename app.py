...
# Definisikan path untuk model. Pastikan struktur folder Anda benar:
# your_project/
# ├── app.py
# └── models/
#     └── best_model.keras
...
def load_labels():
    ...
    Urutan ini KRUSIAL dan harus sama persis dengan urutan saat training.
    """
    return [
...
def clean_label(label: str) -> str:
    ...
    if cleaned == "healthy":
        return "Healthy"
    if "Two-spotted spider mite" in cleaned:
        return "Spider Mites (Two-Spotted)"
    return cleaned.title()

# ====================== DATA DESKRIPSI ==========================
# Kamus ini berisi deskripsi untuk setiap kelas penyakit.
# Kuncinya HARUS cocok dengan output dari fungsi clean_label().
CLASS_DESCRIPTIONS = {
    ...
    "Spider Mites (Two-Spotted)": "Ini adalah serangan hama tungau laba-laba. Daun tampak menguning dengan bintik-bintik kecil, dan jika parah, akan terlihat jaring halus di bawah daun.",
...
# Inisialisasi session state untuk menyimpan hasil agar tidak hilang
...
if selected == "Beranda":
    ...
    st.markdown("Aplikasi ini menggunakan **Convolutional Neural Network (CNN)** untuk mengidentifikasi 9 jenis penyakit dan hama pada daun tomat, serta membedakannya dari daun yang sehat.")
...
# --- HALAMAN DETEKSI ---
    ...
    if image_file:
        ...
        col1, col2 = st.columns([0.8, 1.2]) # Memberi ruang lebih untuk hasil
        ...
        with col2:
            ...
            if st.session_state.prediction_result:
                ...
                prob_df = pd.DataFrame({
                    ...
                    'Probabilitas': result['probabilities'] * 100 # Konversi ke persen
